...
public class CopySources {
    ...
    private static Logger logger = LoggerFactory.getLogger(CopySources.class);
    ...
    private static void help() {
        ...
        String help = "Usage:\n\n" + launcher + "[-help] -xliff xliffFile [-catalog catalogFile]\n" +
                "Where:\n" +
        ...
        if (("trans-unit".equals(root.getName()) && root.getChild("seg-source") == null)
            ...
            if (target == null) {
                ...
                while (it.hasNext()) {
                    ...
                    newContent.add(node);
                    if (node instanceof Element && "source".equals(((Element) node).getName())) {

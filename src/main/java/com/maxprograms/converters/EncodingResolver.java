...
public class EncodingResolver {
    ...
    private static Logger logger = LoggerFactory.getLogger(EncodingResolver.class.getName());
    ...
    public static Charset getEncoding(String fileName, String fileType) {
        if (fileType == null || fileName == null) {
            ...
            try {
                ...
                logger.error("Error detecting XML encoding", e);
            }
            ...
            try {
                ...
                logger.error("Error detecting SRT encoding", e);
            }
            ...
            try {
                ...
                logger.error("Error detecting PHPA encoding", e);
            }
        } else if (fileType.equals(FileFormats.JSON)) {
            try {
                return getJSONEncoding(fileName);
            } catch (IOException e) {
                logger.error("Error detecting JSON encoding", e);
            }
        }
        return null;
    }

...
public class Xliff2Office {
    ...
    private static Logger logger = LoggerFactory.getLogger(Xliff2Office.class.getName());
    ...
    public static List<String> run(Map<String, String> params) {
        ...
        try {
                ...
                try (ZipOutputStream out = new ZipOutputStream(new FileOutputStream(f))) {
                    ...
                    while ((entry = in.getNextEntry()) != null) {
                        if (entry.getName().matches(".*\\.[xX][mM][lL]\\.skl")) {
                            ...
                            if (s == null) {
                                logger.warn("Skeleton not found for file " + name);
                                continue;
                            }
                            table.put("xliff", s);
            ...
            logger.error("Error converting Office file", e);
